...
func (ww *weWork) GetInvoiceInfo(corpId string, query InvoiceInfoQuery) (resp GetInvoiceInfoResponse) {
...
func (ww *weWork) UpdateInvoiceStatus(corpId string, request UpdateInvoiceStatusRequest) (resp internal.BizResponse) {
...
func (ww *weWork) UpdateInvoiceStatusBatch(corpId string, request UpdateInvoiceStatusBatchRequest) (resp internal.BizResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) GetInvoiceInfoBatch(corpId string, query InvoiceInfoQueryBatch) (resp GetInvoiceInfoBatchResponse) {
	if ok := validate.Struct(query); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
