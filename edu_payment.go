...
func (ww *weWork) GetPaymentResult(corpId string, paymentId string) (resp GetPaymentResultResponse) {
	h := H{}
...
func (ww *weWork) GetTrade(corpId string, request GetTradeRequest) (resp GetTradeResponse) {
