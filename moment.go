...
func (ww *weWork) AddMomentTask(corpId string, task MomentTask) (resp AddMomentTaskResponse) {
...
func (ww *weWork) GetMomentTaskResult(corpId string, jobId string) (resp GetMomentTaskResultResponse) {
...
func (ww *weWork) GetMomentList(corpId string, filter MomentListFilter) (resp GetMomentListResponse) {
...
func (ww *weWork) GetMomentTask(corpId string, filter MomentTaskFilter) (resp GetMomentTaskResponse) {
	if ok := validate.Struct(filter); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
	}
...
func (ww *weWork) GetMomentCustomerList(corpId string, filter MomentCustomerFilter) (resp GetMomentCustomerListResponse) {
	if ok := validate.Struct(filter); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
	}
...
func (ww *weWork) GetMomentSendResult(corpId string, filter MomentCustomerFilter) (resp GetMomentSendResultResponse) {
	if ok := validate.Struct(filter); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
	}
...
func (ww *weWork) GetMomentComments(corpId string, momentId string, userId string) (resp GetMomentCommentsResponse) {
...
func (ww *weWork) CancelMomentTask(corpId string, momentId string) (resp internal.BizResponse) {
