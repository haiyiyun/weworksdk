...
func (ww *weWork) KfKnowLedgeAddGroup(corpId string, name string) (resp KfKnowLedgeAddGroupResponse) {
	p := H{"name": name}
...
func (ww *weWork) KfKnowLedgeDelGroup(corpId string, groupId string) (resp internal.BizResponse) {
...
func (ww *weWork) KfKnowLedgeModGroup(corpId string, name string, groupId string) (resp internal.BizResponse) {
...
func (ww *weWork) KfKnowLedgeListGroup(corpId string, filter KfKnowLedgeListGroupFilter) (resp KfKnowLedgeListGroupResponse) {
