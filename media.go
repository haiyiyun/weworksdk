...
func (ww *weWork) MediaUploadAttachment(corpId string, attrs Media) (resp MediaUploadResponse) {
...
func (ww *weWork) MediaUpload(corpId string, fileType MediaType, filePath string) (resp MediaUploadResponse) {
...
func (ww *weWork) MediaUploadImg(corpId string, filePath string) (resp MediaUploadImgResponse) {
	if !isExists(filePath) {
		resp.ErrCode = 500
		resp.ErrorMsg = "文件路径不存在"
		return
...
func (ww *weWork) MediaGet(corpId string, mediaId string) (resp MediaGetResponse) {
	if mediaId == "" {
		resp.ErrCode = 404
		resp.ErrorMsg = "资源不存在"
		return
