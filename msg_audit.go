...
func (ww *weWork) GetPermitUserList(corpId string, T int) (resp GetPermitUserListResponse, err error) {
	if T > 3 || T < 0 {
		resp.ErrCode = 500
...
func (ww *weWork) CheckSingleAgree(corpId string, request CheckSingleAgreeRequest) (resp CheckSingleAgreeResponse, err error) {
...
func (ww *weWork) GetAuditGroupChat(corpId string, roomId string) (resp GetAuditGroupChatResponse, err error) {
	if roomId == "" {
		resp.ErrCode = 500
