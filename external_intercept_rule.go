...
func (ww *weWork) AddInterceptRule(corpId string, interceptRule InterceptRule) (resp AddInterceptRuleResponse) {
...
func (ww *weWork) GetInterceptRuleList(corpId string) (resp GetInterceptRuleListResponse) {
...
func (ww *weWork) GetInterceptRule(corpId string, ruleId string) (resp GetInterceptRuleResponse) {
	h := H{}
	h["rule_id"] = ruleId
...
func (ww *weWork) UpdateInterceptRule(corpId string, request UpdateInterceptRuleRequest) (resp internal.BizResponse) {
...
func (ww *weWork) DeleteInterceptRule(corpId string, ruleId string) (resp internal.BizResponse) {
	h := H{}
	h["rule_id"] = ruleId
	_, err := ww.getRequest(corpId).SetBody(h).SetResult(&resp).
