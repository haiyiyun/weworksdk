...
func (ww *weWork) ExternalContactGetFollowUserList(corpId string) (resp ExternalContactGetFollowUserListResponse) {
...
func (ww *weWork) ExternalContactList(corpId string, userId string) (resp ExternalContactListResponse) {
...
func (ww *weWork) ExternalContactGet(corpId string, externalUserId, cursor string) (resp ExternalContactGetResponse) {
	_, err := ww.getRequest(corpId).SetResult(&resp).
...
func (ww *weWork) ExternalContactBatchGetByUser(corpId string, userIds []string, cursor string, limit int) (resp ExternalContactBatchGetByUserResponse) {
...
func (ww *weWork) ExternalContactRemark(corpId string, remark ExternalContactRemarkRequest) (resp internal.BizResponse) {
...
func (ww *weWork) UnionId2ExternalUserId(corpId string, unionid, openid string) (resp UnionId2ExternalUserIdResponse) {
...
func (ww *weWork) ToServiceExternalUserid(corpId string, externalUserId string) (resp ToServiceExternalUseridResponse) {
