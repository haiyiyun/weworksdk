...
func (ww *weWork) GetUserAllLivingId(corpId string, request GetUserAllLivingIdRequest) (resp GetUserAllLivingIdResponse) {
...
func (ww *weWork) GetLivingInfo(corpId string, liveId string) (resp GetLivingInfoResponse) {
...
func (ww *weWork) GetWatchStat(corpId string, request GetWatchStatRequest) (resp GetWatchStatResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) GetUnWatchStat(corpId string, request GetWatchStatRequest) (resp GetUnWatchStatResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) DeleteReplayData(corpId string, livingId string) (resp internal.BizResponse) {
	h := H{}
	h["livingid"] = livingId
