...
func (ww *weWork) DepartmentCreate(corpId string, department Department) (resp DepartmentCreateResponse) {
...
func (ww *weWork) DepartmentUpdate(corpId string, department Department) (resp internal.BizResponse) {
	if department.Id < 1 {
		resp.ErrCode = 500
...
func (ww *weWork) DepartmentDelete(corpId string, id int32) (resp internal.BizResponse) {
...
func (ww *weWork) DepartmentList(corpId string, id uint) (resp DepartmentListResponse) {
	_, err := ww.getRequest(corpId).SetResult(&resp).
		SetQueryParam("id", fmt.Sprintf("%v", id)).
...
func (ww *weWork) DepartmentSimpleList(corpId string, id int32) (resp DepartmentSimpleListResponse) {
	_, err := ww.getRequest(corpId).SetResult(&resp).
		SetQueryParam("id", fmt.Sprintf("%v", id)).
...
func (ww *weWork) DepartmentGet(corpId string, id int32) (resp DepartmentGetResponse) {
	_, err := ww.getRequest(corpId).SetResult(&resp).
		SetQueryParam("id", fmt.Sprintf("%v", id)).
