...
func (ww *weWork) CreateStudent(corpId string, student Student) (resp internal.BizResponse) {
...
func (ww *weWork) BatchCreateStudent(corpId string, students []Student) (resp BatchStudentResponse) {
	h := H{}
	h["students"] = students
...
func (ww *weWork) DeleteStudent(corpId string, userId string) (resp internal.BizResponse) {
...
func (ww *weWork) BatchDeleteStudent(corpId string, userIdList []string) (resp BatchStudentResponse) {
	h := H{}
...
func (ww *weWork) UpdateStudent(corpId string, student Student) (resp internal.BizResponse) {
...
func (ww *weWork) BatchUpdateStudent(corpId string, students []Student) (resp BatchStudentResponse) {
	h := H{}
	h["students"] = students
	_, err := ww.getRequest(corpId).SetBody(h).SetResult(&resp).
