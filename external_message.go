...
func (ww *weWork) AddMsgTemplate(corpId string, msg ExternalMsg) (resp AddMsgTemplateResponse) {
...
func (ww *weWork) GetGroupMsgListV2(corpId string, filter GroupMsgListFilter) (resp GetGroupMsgListV2Response) {
...
func (ww *weWork) GetGroupMsgTask(corpId string, filter GroupMsgTaskFilter) (resp GetGroupMsgTaskResponse) {
	if ok := validate.Struct(filter); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) GetGroupMsgSendResult(corpId string, filter GroupMsgSendResultFilter) (resp GetGroupMsgSendResultResponse) {
	if ok := validate.Struct(filter); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) RemindGroupMsgSend(corpId string, msgid string) (resp internal.BizResponse) {
	h := H{}
	h["msgid"] = msgid
...
func (ww *weWork) CancelGroupMsgSend(corpId string, msgId string) (resp internal.BizResponse) {
	h := H{}
	h["msgid"] = msgId
	_, err := ww.getRequest(corpId).SetBody(h).SetResult(&resp).
