...
func (ww *weWork) SchoolUserGet(corpId string, userId string) (resp SchoolUserGetResponse) {
...
func (ww *weWork) SchoolUserList(corpId string, departmentId uint32, fetchChild int) (resp SchoolUserListResponse) {
...
func (ww *weWork) SetArchSyncMode(corpId string, mode int) (resp internal.BizResponse) {
	h := H{}
...
func (ww *weWork) GetSubScribeQrCode(corpId string) (resp GetSubScribeQrCodeResponse) {
...
func (ww *weWork) SetSubScribeMode(corpId string, mode int) (resp internal.BizResponse) {
	h := H{}
...
func (ww *weWork) GetSubScribeMode(corpId string) (resp GetSubScribeModeResponse) {
	_, err := ww.getRequest(corpId).SetResult(&resp).
...
func (ww *weWork) BatchToExternalUserId(corpId string, mobiles []string) (resp BatchToExternalUserIdResponse) {
	h := H{}
	h["mobiles"] = mobiles
	_, err := ww.getRequest(corpId).SetBody(h).SetResult(&resp).
...
func (ww *weWork) SetTeacherViewMode(corpId string, mode int) (resp internal.BizResponse) {
	h := H{}
	h["view_mode"] = mode
	_, err := ww.getRequest(corpId).SetBody(h).SetResult(&resp).
...
func (ww *weWork) GetTeacherViewMode(corpId string) (resp GetTeacherViewModeResponse) {
	_, err := ww.getRequest(corpId).SetResult(&resp).
...
func (ww *weWork) GetAllowScope(corpId string, agentId int) (resp GetAllowScopeResponse) {
	_, err := ww.getRequest(corpId).SetResult(&resp).
...
func (ww *weWork) SetUpgradeInfo(corpId string, request UpgradeRequest) (resp UpgradeInfoResponse) {
