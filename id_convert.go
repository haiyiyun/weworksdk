...
func (ww *weWork) IdConvertExternalTagId(corpId string, tagIdList []string) (resp IdConvertExternalTagIdResponse) {
...
func (ww *weWork) UserIdToOpenUserId(corpId string, userIdList []string) (resp UserIdToOpenUserIdResponse) {
...
func (ww *weWork) GetNewExternalUserId(corpId string, userIdList []string) (resp GetNewExternalUserIdResponse) {
	if len(userIdList) > 1000 {
		resp.ErrCode = 500
		resp.ErrorMsg = "参数列表不能超过1000个"
		return
...
func (ww *weWork) GroupChatGetNewExternalUserId(corpId string, request GroupChatGetNewExternalUserIdRequest) (resp GetNewExternalUserIdResponse) {
...
func (ww *weWork) IdConvertOpenKfId(corpId string, kfList []string) (resp IdConvertOpenKfIdResponse) {
	if len(kfList) > 1000 {
		resp.ErrCode = 500
		resp.ErrorMsg = "参数列表不能超过1000个"
		return
