...
func (ww *weWork) KfAccountAdd(corpId string, account KfAccount) (resp KfAccountAddResponse) {
...
func (ww *weWork) KfAccountDel(corpId string, kfId string) (resp internal.BizResponse) {
	if kfId == "" {
		resp.ErrCode = 500
...
func (ww *weWork) KfAccountUpdate(corpId string, account KfAccount) (resp internal.BizResponse) {
	if ok := validate.Struct(account); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) KfAccountList(corpId string, request KfAccountListRequest) (resp KfAccountListResponse) {
...
func (ww *weWork) KfAddContactWay(corpId string, kfId string, scene string) (resp KfAccContactWayResponse) {
	if kfId == "" {
		resp.ErrCode = 500
		resp.ErrorMsg = "客服ID必填"
		return
...
func (ww *weWork) KfServicerAdd(corpId string, request KfServicerRequest) (resp KfServicerResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) KfServicerDel(corpId string, request KfServicerRequest) (resp KfServicerResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) KfServicerList(corpId string, kfId string) (resp KfServicerListResponse) {
...
func (ww *weWork) KfServiceStateGet(corpId string, request KfServiceStateGetRequest) (resp KfServiceStateGetResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) KfServiceStateTrans(corpId string, request KfServiceStateTransRequest) (resp KfServiceStateTransResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) KfSyncMsg(corpId string, request KfSyncMsgRequest) (resp KfSyncMsgResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) KfSendMsg(corpId string, request SendMsgRequest) (resp SendMsgResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) KfSendMsgOnEvent(corpId string, request SendMsgOnEventRequest) (resp SendMsgResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) KfCustomerBatchGet(corpId string, userList []string, needEnterSessionContext int) (resp KfCustomerBatchGetResponse) {
	params := H{}
...
func (ww *weWork) KfGetCorpQualification(corpId string) (resp KfGetCorpQualificationResponse) {
...
func (ww *weWork) KfGetUpgradeServiceConfig(corpId string) (resp KfGetUpgradeServiceConfigResponse) {
	_, err := ww.getRequest(corpId).SetResult(&resp).
...
func (ww *weWork) KfUpgradeService(corpId string, request UpgradeServiceRequest) (resp internal.BizResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) KfCancelUpgradeService(corpId string, request CancelUpgradeServiceRequest) (resp internal.BizResponse) {
	if ok := validate.Struct(request); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) KfGetCorpStatistic(corpId string, filter KfGetCorpStatisticFilter) (resp KfGetCorpStatisticResponse) {
...
func (ww *weWork) KfGetServicerStatistic(corpId string, filter KfGetServicerStatisticFilter) (resp KfGetServicerStatisticResponse) {
	if ok := validate.Struct(filter); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
