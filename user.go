...
// UserCreate 创建成员
func (ww *weWork) UserCreate(corpId string, user User) (resp internal.BizResponse) {
...
// UserGet 读取成员
func (ww *weWork) UserGet(corpId string, userId string) (resp UserGetResponse) {
...
// UserUpdate 更新成员
func (ww *weWork) UserUpdate(corpId string, user User) (resp internal.BizResponse) {
...
// UserDelete 删除成员
func (ww *weWork) UserDelete(corpId string, userId string) (resp internal.BizResponse) {
	_, err := ww.getRequest(corpId).SetQueryParam("userid", userId).SetResult(&resp).
...
func (ww *weWork) UserSimpleList(corpId string, departId int32, fetchChild int) (resp UserSimpleListResponse) {
	if departId <= 0 {
...
func (ww *weWork) UserList(corpId string, departId int32, fetchChild int) (resp UserListResponse) {
	if departId <= 0 {
		resp.ErrCode = 403
...
func (ww *weWork) UserId2OpenId(corpId string, userId string) (resp UserId2OpenIdResponse) {
	p := H{"userid": userId}
...
// https://open.work.weixin.qq.com/api/doc/90001/90143/90338
func (ww *weWork) OpenId2UserId(corpId string, openId string) (resp OpenId2UserIdResponse) {
	p := H{"openid": openId}
	_, err := ww.getRequest(corpId).SetBody(p).SetResult(&resp).
...
func (ww *weWork) ListMemberAuth(corpId string, cursor string, limit int) (resp ListMemberAuthResponse) {
...
func (ww *weWork) CheckMemberAuth(corpId string, openUserId string) (resp CheckMemberAuthResponse) {
...
func (ww *weWork) GetUserId(corpId string, mobile string) (resp GetUserIdResponse) {
	p := H{"mobile": mobile}
	_, err := ww.getRequest(corpId).SetBody(p).SetResult(&resp).
...
func (ww *weWork) ListSelectedTicketUser(corpId string, ticket string) (resp ListSelectedTicketUserResponse) {
...
func (ww *weWork) UserListId(corpId string, cursor string, limit int) (resp UserListIdResponse) {
	p := H{"cursor": cursor, "limit": limit}
	_, err := ww.getRequest(corpId).SetBody(p).SetResult(&resp).
