...
func (ww *weWork) ExternalAddContactWay(corpId string, me ContactMe) (resp ContactMeAddResponse) {
...
func (ww *weWork) ExternalUpdateContactWay(corpId string, me ContactMe) (resp internal.BizResponse) {
	if ok := validate.Struct(me); ok != nil {
		resp.ErrCode = 500
		resp.ErrorMsg = ok.Error()
		return
...
func (ww *weWork) ExternalGetContactWay(corpId string, configId string) (resp ContactMeGetResponse) {
...
func (ww *weWork) ExternalListContactWay(corpId string, startTime, endTime int64, cursor string, limit int) (resp ContactMeListResponse) {
...
func (ww *weWork) ExternalDeleteContactWay(corpId string, configId string) (resp internal.BizResponse) {
	p := H{"config_id": configId}
	_, err := ww.getRequest(corpId).SetBody(p).SetResult(&resp).
...
func (ww *weWork) ExternalCloseTempChat(corpId string, userId, externalUserId string) (resp internal.BizResponse) {
