...
func (ww *weWork) SchoolDepartmentCreate(corpId string, department SchoolDepartment) (resp SchoolDepartmentCreateResponse) {
...
func (ww *weWork) SchoolDepartmentUpdate(corpId string, department SchoolDepartment) (resp internal.BizResponse) {
	if department.Id < 0 {
		resp.ErrCode = 500
...
func (ww *weWork) SchoolDepartmentDelete(corpId string, departmentId int32) (resp internal.BizResponse) {
...
func (ww *weWork) SchoolDepartmentList(corpId string, departmentId int32) (resp SchoolDepartmentListResponse) {
	_, err := ww.getRequest(corpId).
		SetQueryParam("id", fmt.Sprintf("%v", departmentId)).
