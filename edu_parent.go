...
func (ww *weWork) CreateParent(corpId string, parent Parent) (resp internal.BizResponse) {
...
func (ww *weWork) BatchCreateParent(corpId string, parents []Parent) (resp BatchParentResponse) {
	h := H{}
	h["parents"] = parents
...
func (ww *weWork) DeleteParent(corpId string, userId string) (resp internal.BizResponse) {
...
func (ww *weWork) BatchDeleteParent(corpId string, userIdList []string) (resp BatchParentResponse) {
	h := H{}
...
func (ww *weWork) UpdateParent(corpId string, parent Parent) (resp internal.BizResponse) {
...
func (ww *weWork) BatchUpdateParent(corpId string, parents []Parent) (resp BatchParentResponse) {
	h := H{}
	h["parents"] = parents
	_, err := ww.getRequest(corpId).SetBody(h).SetResult(&resp).
...
func (ww *weWork) ListParentWithDepartmentId(corpId string, departmentId int32) (resp ListParentWithDepartmentIdResponse) {
