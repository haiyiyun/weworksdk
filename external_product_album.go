...
func (ww *weWork) AddProductAlbum(corpId string, product Product) (resp AddProductAlbumResponse) {
...
func (ww *weWork) GetProductAlbum(corpId string, productId string) (resp GetProductAlbumResponse) {
	h := H{}
...
func (ww *weWork) GetProductAlbumList(corpId string, limit int, cursor string) (resp GetProductAlbumListResponse) {
	h := H{}
	h["limit"] = limit
	h["cursor"] = cursor
	_, err := ww.getRequest(corpId).SetBody(h).SetResult(&resp).
...
func (ww *weWork) UpdateProductAlbum(corpId string, request ProductUpdateRequest) (resp internal.BizResponse) {
...
func (ww *weWork) DeleteProductAlbum(corpId string, productId string) (resp internal.BizResponse) {
	h := H{}
	h["product_id"] = productId
	_, err := ww.getRequest(corpId).SetBody(h).SetResult(&resp).
