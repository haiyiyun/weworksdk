...
func (ww *weWork) CorpTagList(corpId string, tagIds, groupIds []string) (resp CorpTagListResponse) {
...
func (ww *weWork) CorpTagAdd(corpId string, tagGroup CorpTagGroup) (resp CorpTagAddResponse) {
	_, err := ww.getRequest(corpId).
...
func (ww *weWork) CorpTagUpdate(corpId string, tag CorpTag) (resp internal.BizResponse) {
	_, err := ww.getRequest(corpId).
...
func (ww *weWork) CorpTagDelete(corpId string, tagIds, groupIds []string) (resp internal.BizResponse) {
	p := H{"tag_id": tagIds, "group_id": groupIds}
	_, err := ww.getRequest(corpId).
		SetBody(p).SetResult(&resp).
...
func (ww *weWork) MarkTag(corpId string, userId string, externalUserId string, addTag []int, removeTag []int) (resp internal.BizResponse) {
