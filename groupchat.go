...
func (ww *weWork) GroupChatList(corpId string, filter GroupChatListFilter) (resp GroupChatListResponse) {
...
func (ww *weWork) GroupChat(corpId string, request GroupChatRequest) (resp GroupChatResponse) {
...
func (ww *weWork) GroupOpengId2ChatId(corpId string, opengid string) (resp GroupOpengId2ChatIdResponse) {
	p := H{"opengid": opengid}
